...
public class GlobalErrorHandlerAdvice {
    ...
    public ResponseEntity<DefaultErrorMessage> handleNotEnoughFundsException(NotEnoughFundsException e) {
        var error = new DefaultErrorMessage(HttpStatus.UNPROCESSABLE_ENTITY.value(), e.getReason());
